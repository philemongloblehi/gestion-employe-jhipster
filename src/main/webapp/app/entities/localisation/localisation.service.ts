...
export class LocalisationService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/localisations';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<ILocalisation[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
