...
public class RegionResourceIntTest {
    ...
    private static final String DEFAULT_REGION_LIBELLE = "AAAAAAAAAA";
    private static final String UPDATED_REGION_LIBELLE = "BBBBBBBBBB";
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region()
            .regionLibelle(DEFAULT_REGION_LIBELLE);
        return region;
    }
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getRegionLibelle()).isEqualTo(DEFAULT_REGION_LIBELLE);
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].regionLibelle").value(hasItem(DEFAULT_REGION_LIBELLE.toString())));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.regionLibelle").value(DEFAULT_REGION_LIBELLE.toString()));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        updatedRegion
            .regionLibelle(UPDATED_REGION_LIBELLE);
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getRegionLibelle()).isEqualTo(UPDATED_REGION_LIBELLE);
