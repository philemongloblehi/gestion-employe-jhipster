...
export class RegionUpdatePage {
    ...
    regionLibelleInput = element(by.id('field_regionLibelle'));

    async getPageTitle() {
        return this.pageTitle.getAttribute('jhiTranslate');
    }

    async setRegionLibelleInput(regionLibelle) {
        await this.regionLibelleInput.sendKeys(regionLibelle);
    }

    async getRegionLibelleInput() {
        return this.regionLibelleInput.getAttribute('value');
    }
