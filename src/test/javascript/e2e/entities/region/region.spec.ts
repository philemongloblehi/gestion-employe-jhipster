...
describe('Region e2e test', () => {
    ...
    it('should load Regions', async () => {
        ...
        expect(await regionComponentsPage.getTitle()).to.eq('gestionEmployeAkilApp.region.home.title');
    });
    ...
    it('should load create Region page', async () => {
        ...
        expect(await regionUpdatePage.getPageTitle()).to.eq('gestionEmployeAkilApp.region.home.createOrEditLabel');
    ...
    it('should create and save Regions', async () => {
        ...
        await regionComponentsPage.clickOnCreateButton();
        await promise.all([regionUpdatePage.setRegionLibelleInput('regionLibelle')]);
        expect(await regionUpdatePage.getRegionLibelleInput()).to.eq('regionLibelle');
    ...
    it('should delete last Region', async () => {
        ...
        expect(await regionDeleteDialog.getDialogTitle()).to.eq('gestionEmployeAkilApp.region.delete.question');
