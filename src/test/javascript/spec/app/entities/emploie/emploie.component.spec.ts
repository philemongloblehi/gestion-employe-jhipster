...
import { EmploieComponent } from 'app/entities/emploie/emploie.component';
import { EmploieService } from 'app/entities/emploie/emploie.service';
import { Emploie } from 'app/shared/model/emploie.model';

describe('Component Tests', () => {
    describe('Emploie Management Component', () => {
        let comp: EmploieComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EmploieComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.emploies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
