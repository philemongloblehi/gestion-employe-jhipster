...
describe('Service Tests', () => {
    describe('Localisation Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Localisation(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Localisation', async () => {
                const returnedFromService = Object.assign(
                    {
                        adresse: 'BBBBBB',
                        codePostal: 'BBBBBB',
            ...
            it('should delete a Localisation', async () => {
